...
const CONTENT = {
  KO: {
    label: "제품라인업",
    heading: "필요한 형태로 공급합니다",
    subheading: "동일한 광열 플랫폼에서, 공정에 바로 투입 가능한 형태로 제공합니다.",
    products: [
      {
        title: "파우더",
  ...
  EN: {
    ...
    heading: "Supplied in the Format You Need",
    subheading: "From a single photothermal platform, delivered ready to drop into your process.",
    products: [
      {
        title: "Powder",
        codes: "CH-PDG · CH-GNP · CH-MAG",
        body: "High-purity graphene powder. Composite powders with metal (Ag/Cu) anchoring are also available for enhanced conductivity.",
        alt: "Powder product image",
      },
      {
        title: "Paste · Ink",
        codes: "CH-GP · CH-MGP · CH-PFCM",
        body: "Conductive paste optimized for screen printing and particle-free metal ink. Applied to printed electronics, heaters, and antennas.",
        alt: "Paste and ink product image",
      },
      {
        title: "Composites",
        codes: "CH-GER · CH-GM",
        body: "Available as epoxy resin and thermoplastic masterbatch. Drop into your existing compounding process without changes.",
        alt: "Composite material product image",
      },
      {
        title: "Functional Materials",
        codes: "CH-CQD",
        body: "Carbon quantum dots leveraging optical properties. Applied in bioimaging and sensor fields.",
        alt: "Functional material product image",
      },
    ],
  },
} as const;
    ...
    <section className="py-32 bg-surface" id="products">
      <div className="max-w-max-width mx-auto px-gutter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {t.products.map(({ title, codes, body, alt }) => (
            <div
              key={title}
